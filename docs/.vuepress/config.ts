...
const DOMAIN_NAME = 'kobo.tssn.ac.cn' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "Side - 7",
      description: 'Write down what you did.',
    }
  },
  ...
  themeConfig: {
    ...
    author: {
      name: 'gingerbeam', // 必需
      link: 'https://github.com/gingerbeam', // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:gingerbeam@outlook.com',
        },
        {
    ...
    footer: {
      ...
      copyrightInfo:
        '<a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
